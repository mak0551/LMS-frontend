...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-20 flex items-center justify-between px-6 py-3 bg-white shadow-md">
      <Link to="/" className="text-2xl text-black font-serif w-[10%]">
        LMS
      </Link>
      ...
      <div className="flex items-center gap-4 w-[80%]">
        <div className="relative flex-1 mx-4 hidden lg:flex ">
          <input
            ...
            className="w-full px-4 py-2 border border-black rounded-full focus:outline-none focus:ring focus:ring-gray-300"
          />
          {searchTerm.trim() !== "" && (
        ...
        <ul className="hidden md:flex items-center space-x-6 text-black lg:w-1/2 xl:w-[40%] justify-center xl:gap-6 gap-2 ">
        ...
        <div className="flex items-center">
          {user ? (
            <div className="relative hidden md:flex items-center group">
              ...
              {/* hover card */}
              <div className="absolute top-12 right-0 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <OnProfileHover />
              </div>
            </div>
          ) : (
